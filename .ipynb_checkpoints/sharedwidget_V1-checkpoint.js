...
//groups all groups together
    ...
    //Create Check Box
      ...
      stretchGroup.style.marginTop = ".5rem";
...
function renderTopControlPanel({ model, el }) {
    ...
    //group label and input together
      ...
      cropwidthLabel.title = "width of the image (pixels)";
      ...
      cropheightLabel.title = "height of the image (pixels)";
      ...
      cropheightGroup.style.marginTop = ".5rem";
